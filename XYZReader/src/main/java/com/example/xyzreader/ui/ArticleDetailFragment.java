...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        descriptionContainer = mRootView.findViewById(R.id.description_container);
    ...
    private void updateStatusBar() {
        ...
        if (appBarLayout != null && appBarLayout.getTotalScrollRange() != 0) {
            ...
            float f = colorOffset + ((float) Math.abs(offSet) * (1-colorOffset) / appBarLayout.getTotalScrollRange());
        ...
        mPhotoView.setBackgroundColor(color);
    }
    ...
    public int getUpButtonFloor() {
        ...
        return appBarLayout.getTotalScrollRange() + offSet;
    }
}
